...
if(isset($_POST['create']))
{
  ...
  $ti=mysqli_real_escape_string($conn,$_POST['ti']);
  $addnote=mysqli_real_escape_string($conn,$_POST['addnote']);
  $header=mysqli_real_escape_string($conn,$_POST['header']);
  $body=mysqli_real_escape_string($conn,$_POST['body']);
  $footer=mysqli_real_escape_string($conn,$_POST['footer']);
  $venue=mysqli_real_escape_string($conn,$_POST['venue']);
  $hfc=mysqli_real_escape_string($conn,$_POST['hfc']);
  $hbc=mysqli_real_escape_string($conn,$_POST['hbc']);
  $bfc=mysqli_real_escape_string($conn,$_POST['bfc']);
  $bbc=mysqli_real_escape_string($conn,$_POST['bbc']);
  $ffc=mysqli_real_escape_string($conn,$_POST['ffc']);
  $fbc=mysqli_real_escape_string($conn,$_POST['fbc']);
  $deadline=mysqli_real_escape_string($conn,$_POST['deadline']);
  $pri=mysqli_real_escape_string($conn,$_POST['privateinvite']);
